...
final class BuildBlockManager{
	...
	public function __construct(
		...
		$this->arena->getPlugin()->getScheduler()->scheduleRepeatingTask(new BuildBlockManagerUpdateTask($this), 20);
	}
