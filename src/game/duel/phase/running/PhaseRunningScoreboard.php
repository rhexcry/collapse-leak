...
class PhaseRunningScoreboard extends PhaseScoreboard{
	...
	private function setSoloScoreboard() : void{
		$this->setLines([
			1 => TextFormat::GRAY . Font::SCOREBOARD_LINE,
			2 => CollapseTranslationFactory::duels_phase_running_scoreboard_opponent(),
			4 => null,
			5 => CollapseTranslationFactory::duels_phase_running_scoreboard_your_ping((string) $this->player->getNetworkSession()->getPing()),
			6 => null,
	...
	private function updateSoloScoreboard() : void{
		$this->setLine(5, CollapseTranslationFactory::duels_phase_running_scoreboard_your_ping((string) $this->player->getNetworkSession()->getPing()));
		...
		$this->setLine(3, CollapseTranslationFactory::duels_phase_running_scoreboard_opponent_info(
