...
namespace collapse\world\format;
...
final class CollapseLevelDB extends BaseWorldProvider implements WritableWorldProvider{
	protected const int FINALISATION_NEEDS_INSTATICKING = 0;
	protected const int FINALISATION_NEEDS_POPULATION = 1;
	protected const int FINALISATION_DONE = 2;

	protected const string ENTRY_FLAT_WORLD_LAYERS = "game_flatworldlayers";

	protected const int CURRENT_LEVEL_CHUNK_VERSION = ChunkVersion::v1_21_40;
	protected const int CURRENT_LEVEL_SUBCHUNK_VERSION = SubChunkVersion::PALETTED_MULTI;

	private const int CAVES_CLIFFS_EXPERIMENTAL_SUBCHUNK_KEY_OFFSET = 4;
	...
	public function loadChunk(int $chunkX, int $chunkZ) : ?LoadedChunkData{
		...
		switch($chunkVersion){
			...
			case ChunkVersion::v1_0_0:
				...
				}catch(CorruptedChunkException){ //TODO: HACK
					return null;
				}
